                    ...
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?= $usuario['nombres'] ?> <?= $usuario['apellidos'] ?></span>
                                <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text"><?= $usuario['rol'] ?></span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header"><?= $usuario['nombres'] ?> <?= $usuario['apellidos'] ?>!</h6>
                        ...
                        <a class="dropdown-item" href="<?= URL . 'login/cerrarsesion' ?>"><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i>
